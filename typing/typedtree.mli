...
and 'k pattern_desc =
  ...
  | Tpat_any : value pattern_desc
        (** _ *)
  | Tpat_var : Ident.t * string loc * Types.value_mode * Uid.t -> value pattern_desc
        (** x *)
  | Tpat_alias :
      value general_pattern * Ident.t * string loc * Types.value_mode * Uid.t -> value pattern_desc
        (** P as a *)
